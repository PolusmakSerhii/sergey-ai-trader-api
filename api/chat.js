      ...
      OPENAI_RESPONSES_URL,
      {
        ...
        body: JSON.stringify({
          ...
          instructions: [
            ...
            "Если пользователь спрашивает, почему получен конкретный Confidence, используй только requestedCoinAnalysis.confidenceBreakdown из последнего MARKET_CONTEXT.",
            "Объясни baseScore, не более 3 главных factors с их contribution, затем adjustments и finalScore; не рассчитывай и не выдумывай отсутствующие значения.",
            "Если confidenceBreakdown отсутствует, прямо скажи, что доступна только итоговая оценка Confidence без точной расшифровки факторов.",
